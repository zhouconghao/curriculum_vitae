...
\begin{cv}{\spacedallcaps{Zhou, Conghao}}\vspace{1.5em} % Your name
    ...
    \Description{\MarginText{}dark matter\ \ $\cdotp$\ \ gravitational lensing\ \ $\cdotp$\ \ galaxy clusters \ \ $\cdotp$\ large scale structure \ $\cdotp$\ \ multi-wavelength~cosmology }
    ...
    \Description{\MarginText{2023}Starlight Over Street Light}
